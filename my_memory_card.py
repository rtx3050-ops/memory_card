...
q1 = Question('Какого типа данных нет в Python?', 'double', 'int', 'float', 'str')
q2 = Question('Какого типа данных нет в Python?', 'array', 'tuple', 'list', 'dict')
q3 = Question('какой функции нет в Python?', 'output', 'input', 'print', 'len')
question_list = list()
